<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registeration.aspx.cs" Inherits="weapon.registeration" %>
...
<div id="single-wrapper">
	<form action="#" class="frm-single" name="form1" runat="server">
		<div class="inside">
			<div class="title"><strong>Weapon</strong> Management System</div>
			...
			<div class="frm-input"><asp:TextBox ID="email" runat="server" class="frm-inp" placeholder="E-mail"></asp:TextBox><i class="fa fa-envelope frm-ico"></i></div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user1.aspx.cs" Inherits="weapon.user1" %>
...
<div id="single-wrapper">
	<form id="form1" runat="server" class="frm-single">
		<div class="inside">
			<div class="title"><strong>Weapon</strong></div>
			<div class="frm-title">User Login</div>
